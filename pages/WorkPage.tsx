...
const projects: Project[] = [
    ...
    },
    {
        ...
        appStoreUrl: 'https://play.google.com/store/apps/details?id=com.brickspace',
        isExternal: true,
        icon: Smartphone,
        accentColor: '#3b82f6',
        metrics: [
...
export const WorkPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-[#050A14] text-slate-200 font-sans selection:bg-blue-500/30 pt-32">
            ...
            {/* Category Filter */}
            <section className="sticky top-20 z-30 py-6 px-6 border-y border-white/5 bg-[#050A14]/80 backdrop-blur-md">
